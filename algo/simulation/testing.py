...
def get_maps():
    ...
    maps.append([Obstacle(10, 38, 'N'), Obstacle(17, 36, 'N'), Obstacle(24, 10, 'S'), Obstacle(32, 20, 'S'), 
    ...
    maps.append([Obstacle(8, 8, 'N'), Obstacle(8, 18, 'N'), Obstacle(26, 26, 'E'), Obstacle(34, 32, 'W')])
